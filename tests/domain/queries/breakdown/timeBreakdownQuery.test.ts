...
describe('timeBreakdownQuery tests', () => {
    ...
    it('gets query with resource from', () => {
        // ARRANGE
        const selector = selectorObjectMother.get('Patient', 'patient', [deceasedDateField], [], undefined);
    ...
    it('gets query with filters applied', () => {
        // ARRANGE
        const selector = selectorObjectMother.get('Patient', 'patient', [deceasedDateField], [femaleGenderFilter], undefined);
    ...
    it('gets query with cross join and filters applied when one field is array type', () => {
        // ARRANGE
        const selector = selectorObjectMother.get('Patient', 'patient', [deceasedDateField], [femaleGenderFilter]);
